...
<body class = "sony">
	...
	$sql = "SELECT ID, name, quantity, price,image FROM phone_list where category='Sony'";
...
<?php endif; ?>
	...
	<div class="thumbnail">
	  <img id="product-image" class="identifyingClass img-responsive scale" onerror = "this.src='picture/image_error.png'" src="picture/Category_3/<?php echo $row['image']; ?>"
