...
<body class = "apple">
	...
	$sql = "SELECT ID, name, quantity, price,image FROM phone_list where category='Apple'";
...
<?php endif; ?>
	...
	<div class="thumbnail">
	  ...
	  <img id="product-image" class="identifyingClass img-responsive scale" onerror = "this.src='picture/image_error.png'" src="picture/Category_1/<?php echo $row['image']; ?>"
