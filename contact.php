...
<body class = "home">
	...
	?>
                ...
                <form data-toggle="validator" class="form-horizontal form2 	" method="post" action="contact_handle.php">
                    <fieldset>
						...
						<p>Fill in the form to give us some feedback:</p>
						<p>Your feedback is the best way to help us improve, Thank You!</p>
						</legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control message" id="message" name="message" placeholder="Enter your feedback here." rows="7"
