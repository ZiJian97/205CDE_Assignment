...
<body class = "huawei">
	...
	$sql = "SELECT ID, name, quantity, price,image FROM phone_list where category='Huawei'";
...
<?php endif; ?>
	...
	<div class="thumbnail">
	  <img id="product-image" class="identifyingClass img-responsive scale" onerror = "this.src='picture/image_error.png'" src="picture/Category_5/<?php echo $row['image']; ?>"
