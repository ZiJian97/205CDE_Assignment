					   ...
					   <form method = "post" action="order_confirm.php">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
								...
								<input class = "form-control" name = "select" type = "number" placeholder = "QTY" style = "width:80px; height:20px"/>
                        ...
                        <div class="btn-ground">
                       	  ...
                       	  <Button type="submit" class="identifyingClass2 btn btn-success"><span class="glyphicon glyphicon-shopping-cart"></span> Purchase Now</button>
