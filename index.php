...
<?php endif; ?>
	...
	<div class="content">
		<h1 id="home_text">Welcome to What's Hot Online Phone Shop</h1>
		<p id="home_btn"><a href="category.php"><button type="button" class="btn btn-primary">Enter Now</button></a></p>
	</div>	
	</div>	
